...
tek2s = ["Код МО", "Наименование структурного подразделения медицинской организации", "Название проекта по улучшению", "Улучшаемый процесс", "Улучшаемый процесс (другое)", "Улучшаемый подпроцесс", "Улучшаемый подпроцесс (другое)", "Дата открытия проекта", "Плановая дата закрытия проекта (в соответствии с паспортом проекта по улучшению)", "Фактическая дата закрытия проекта", " Этап  реализации проекта", "Полученный экономический эффект", "Связь проекта с организацией медицинской помощи в условиях COVID 19", "Руководителя заместителя руководителя медицинской организации", "Работника РЦ ПМСП"]
Tek2 = ltable[tek2s]
